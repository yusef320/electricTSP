...
- <code> simulation.py </code> is the scrip that simulated the routes trough the months of October and Novemeber 2022. It uses the traffic data in <code> simulationOctober.csv</code> and <code> simulationNovember.csv</code>
